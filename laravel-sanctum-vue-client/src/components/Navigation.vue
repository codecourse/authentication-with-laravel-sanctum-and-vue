  ...
  <header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
      ...
      <div class="flex lg:hidden">
        <button v-on:click="mobileNavigationOpen = true" type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
    ...
    <!-- Mobile menu -->
    <div class="lg:hidden" v-if="mobileNavigationOpen">
      <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:ring-1 sm:ring-gray-900/10">
        <div class="flex items-center justify-between">
          ...
          <button type="button" class="-m-2.5 rounded-md p-2.5 text-gray-700" v-on:click="mobileNavigationOpen = false">
